...
/**
 * A {@link PredictionsDecoder} for the XGBoost {@code reg:absoluteerror} objective.
 *
 * <p>XGBoost outputs a raw continuous value in the same unit as the training labels (MAE
 ...
 */
public record RegressionAbsoluteErrorObjectiveDecoder(
        Normalizer<Float, Double> normalizer) implements PredictionsDecoder<Double, DefaultPrediction<Double>> {

    /**
     * Decodes and normalises predictions from a {@code reg:absoluteerror} raw output matrix.
     *
