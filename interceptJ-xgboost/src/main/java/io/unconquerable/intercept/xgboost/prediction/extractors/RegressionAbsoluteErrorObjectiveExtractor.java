...
/**
 * A {@link PredictionsExtractor} for the XGBoost {@code reg:absoluteerror} objective.
 *
...
public record RegressionAbsoluteErrorObjectiveExtractor(
    ...
    /**
     * Extracts and normalises predictions from a {@code reg:absoluteerror} raw output matrix.
     *
