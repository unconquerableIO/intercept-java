...
/**
 * A {@link PredictionsExtractor} for the XGBoost {@code binary:logitraw} objective.
 *
...
public record BinaryLogitrawObjectiveExtractor(Normalizer<Float, Double> normalizer)
    ...
    /**
     * Extracts and normalises predictions from a {@code binary:logitraw} raw output matrix.
     *
