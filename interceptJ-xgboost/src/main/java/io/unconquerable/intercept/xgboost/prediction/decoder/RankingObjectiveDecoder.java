...
/**
 * A {@link PredictionsDecoder} for XGBoost ranking objectives (e.g. {@code rank:pairwise},
...
public record RankingObjectiveDecoder(
    ...
    /**
     * Decodes and batch-normalizes predictions from a ranking objective raw output matrix.
     *
